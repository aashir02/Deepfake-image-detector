...
def main():
    DATADIR = r"C:\Users\ashir\OneDrive\Pictures\MyDataset"
    ...
    # No need to copy images to directories or preprocess them separately
    # Just use the dataset instance to create DataLoader
    ...
    for inputs, labels in test_loader:
        ...
        # Assuming processed_image is obtained from inputs
        processed_image = inputs[0]  # Get the first image from inputs
